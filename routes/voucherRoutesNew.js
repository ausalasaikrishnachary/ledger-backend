...
const voucherData = {
  ...
  // Add product_id and batch_id fields
  product_id: transactionData.primaryProductId || batchDetails[0]?.product_id || null,
  batch_id: transactionData.primaryBatchId || batchDetails[0]?.batch_id || null
};
