...
// Create a new product (UPDATED WITH DISCOUNT)
router.post('/products', async (req, res) => {
  ...
  try {
    ...
    console.log('Discount:', data.discount); // ADDED DISCOUNT LOG
    ...
    console.log('✅ Product created with stock:', {
      ...
      discount: data.discount // ADDED DISCOUNT
    });
...
// Update a product (UPDATED WITH DISCOUNT)
